...
- **Agent 模式**：基于 RP Agent 架构的高级角色扮演系统，分层"客观世界 / 人物具身状态 / 主观认知与意图 / 仲裁"，SQLite 存储。详见 [10_agent_data_and_simulation.md](10_agent_data_and_simulation.md) + [11_agent_runtime.md](11_agent_runtime.md)。
...
| 灵力档位 | 6 档（Mundane / Awakened / Adept / Master / Transcendent / Legendary），边界对 `D:\AI\rp_cards\` 锚点校准 | 用档位识别身份，用数值差识别实力 |
...
| 跨档差阈值 | 200 / 500 / 1000；仲裁层 1000+ 即 Crushing | 200 起感觉差距、1000+ 基本无力应对 |
