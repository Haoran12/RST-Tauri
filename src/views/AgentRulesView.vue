...
import WorldRulesEditor from '@/components/agent/world-editor/WorldRulesEditor.vue'
...
async function loadData() {
  ...
  try {
    ...
    editorStore.selectEntity('world_rules', 'world_argument')
  } catch (e) {
    message.error(`加载世界规则失败: ${String(e)}`)
  }
}

async function handleSelectRules() {
  editorStore.selectEntity('world_rules', 'world_argument')
  // TODO: Load actual world rules data and init draft
}
